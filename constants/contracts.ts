...
export const RIDE_SHARE_ABI = [
	...
	},
	{
		"inputs": [
			...
			{
				"internalType": "enum CrydaRideShare.PaymentMethod",
				"name": "_paymentMethod",
				"type": "uint8"
			}
		],
	...
	},
	{
		...
		"outputs": [
			...
			{
				"internalType": "enum CrydaRideShare.BookingStatus",
				"name": "status",
				"type": "uint8"
			},
			{
		...
		"outputs": [
			{
				...
				"internalType": "struct CrydaRideShare.Booking",
				"name": "",
				"type": "tuple"
			}
		],
		...
		"outputs": [
			{
				"components": [
					...
					{
						"internalType": "enum CrydaRideShare.RideStatus",
						"name": "status",
						"type": "uint8"
					},
					{
				...
				"internalType": "struct CrydaRideShare.Ride",
				"name": "",
				"type": "tuple"
			}
		],
